...
<div align="center">
  <a href="https://spike-messageboard.vercel.app/" target="_blank">
...
Based on that, I decided to try a more realistic setup: hosting the Next.js frontend on Vercel, and deploying the Express backend separately on Lightsail, communicating through APIs. This decision led the project to naturally expand into a full-stack–like experience, involving backend APIs, authentication, database integration, and server-side deployment.
